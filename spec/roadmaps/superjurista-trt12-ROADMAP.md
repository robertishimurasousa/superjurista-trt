...
1. Build the protected claim matrix from the eight claimant and seven defense positions, preserving joint/subsidiary liability as `missing_respondent_position` and every unsupported category as a review gap.
