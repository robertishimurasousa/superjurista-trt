...
| ID | Entrega | Pontos | Situação | Critério de aceite | Evidências |
|---|---|---:|---|---|---|
| OPS-01 | Manual de instalação e operação | 1 | `ACCEPTED` | Ensaio limpo do operador conclui apenas com o manual | [`spec/operations/trt12-first-instance-operator-runbook.md`](../operations/trt12-first-instance-operator-runbook.md), [`scripts/rehearse_target_host.py`](../../scripts/rehearse_target_host.py) e [`scripts/run_synthetic_pipeline.py`](../../scripts/run_synthetic_pipeline.py); checkout limpo de `development` no commit `1c6c830` seguiu o manual no macOS, criou ambiente Python 3.12, instalou dependências, retornou resumo de prontidão `f925340cc3be04b5ef1dffe47ac317a64e0ec452eb6688f5350dc571647f1515`, passou controle de 257 testes e quatro testes entre ambientes, gerou 19 artefatos e controle global aprovado em Claude Code e Codex, com resumo de contrato `277b660604f3512f0925b4266d669345fa2e7b84212e9769946db6fcb71aa59c` e resumo dos artefatos `7cbc39dab48426a72579e9cbb761dcd00363736f08e356b81c966e6fbe715a12` iguais |
