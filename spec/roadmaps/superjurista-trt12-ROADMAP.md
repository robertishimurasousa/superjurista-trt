...
| DOM-02 | Procedural timeline and labor report | 3 | `IN_PROGRESS` | Dates, parties, procedural phase, claims, defenses, and source locators pass blind sample review | [`runtime/contracts/schemas/procedural-timeline.v1.schema.json`](../../runtime/contracts/schemas/procedural-timeline.v1.schema.json), [`runtime/contracts/schemas/labor-report.v1.schema.json`](../../runtime/contracts/schemas/labor-report.v1.schema.json), [`scripts/build_procedural_timeline.py`](../../scripts/build_procedural_timeline.py), [`scripts/build_labor_report.py`](../../scripts/build_labor_report.py), [`scripts/extract_pje_labor_report.py`](../../scripts/extract_pje_labor_report.py), `tests/test_procedural_timeline_builder.py`, `tests/test_labor_report_builder.py`, and `tests/test_pje_labor_report_extraction.py`; the deterministic suites cover every supported labor-document type, source locators, unknown and conflict gaps, exact PDF/segment/classification/timeline custody, metadata-to-initial-party reconciliation, multiple respondents, portable tribunal and instance inputs, protected output, and executable CLIs. The authorized TRT12 process produced a schema-valid protected report with three source-linked parties, identified first-instance knowledge phase and court unit, all 49 dated events, no inferred positions, and exactly two explicit gaps for claim and defense extraction. No process content was tracked. Claim and defense position extraction plus blind legal review against an approved multi-case TRT12 fixture set remain required before acceptance |
